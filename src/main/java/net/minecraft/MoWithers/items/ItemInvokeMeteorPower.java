...
public class ItemInvokeMeteorPower extends Item
{
  public ItemInvokeMeteorPower(String unlocalizedName)
  {
  ...
  public ItemStack onItemRightClick(ItemStack itemStackIn, World worldIn, EntityPlayer playerIn)
  {
      ...
      if (!worldIn.isRemote)
      {
          ...
          EntityMeteorShower entitylargefireball = new EntityMeteorShower(worldIn, playerIn.posX, playerIn.posY + 8D, playerIn.posZ);
          Iterator iterator = worldIn.playerEntities.iterator();
          EntityPlayer entityplayer;
          if (iterator.hasNext())
          {
              entityplayer = (EntityPlayer)iterator.next();
              entityplayer.addChatMessage(new TextComponentString(playerIn.getName() + " has invoked the Meteor Shower Power!"));
          }
