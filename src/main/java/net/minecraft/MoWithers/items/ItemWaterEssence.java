...
public class ItemWaterEssence extends Item
{
  public ItemWaterEssence(String unlocalizedName)
  {
  ...
  public ItemStack onItemRightClick(ItemStack itemStackIn, World worldIn, EntityPlayer playerIn)
  {
      ...
      EntityWaterCurrent entitylargefireball = new EntityWaterCurrent(worldIn, playerIn, d2, d3, d4);
