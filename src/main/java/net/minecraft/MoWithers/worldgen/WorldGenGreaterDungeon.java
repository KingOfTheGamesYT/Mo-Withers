...
public class WorldGenGreaterDungeon extends WorldGenerator
{
    private static final Logger field_175918_a = LogManager.getLogger();
    private static final String[] SPAWNERTYPES = new String[] {"Skeleton", "Creeper", "Enderman", "CaveSpider"};
    private static final List CHESTCONTENT = Lists.newArrayList(new WeightedRandomChestContent[] {new WeightedRandomChestContent(Items.saddle, 0, 1, 1, 10),new WeightedRandomChestContent(Items.diamond, 0, 1, 2, 5), new WeightedRandomChestContent(Items.iron_ingot, 0, 2, 5, 20), new WeightedRandomChestContent(Items.iron_ingot, 0, 5, 10, 20), new WeightedRandomChestContent(Items.bread, 0, 3, 8, 20), new WeightedRandomChestContent(Items.apple, 0, 3, 8, 20), new WeightedRandomChestContent(Items.wheat, 0, 5, 12, 10), new WeightedRandomChestContent(new ItemStack(Blocks.tnt), 1, 1, 5), new WeightedRandomChestContent(Items.string, 0, 8, 24, 20), new WeightedRandomChestContent(Items.bucket, 0, 1, 1, 10), new WeightedRandomChestContent(Items.golden_apple, 0, 1, 1, 5), new WeightedRandomChestContent(Items.golden_apple, 1, 1, 1, 1), new WeightedRandomChestContent(Items.redstone, 0, 6, 24, 10), new WeightedRandomChestContent(Items.record_13, 0, 1, 1, 4), new WeightedRandomChestContent(Items.record_cat, 0, 1, 1, 4), new WeightedRandomChestContent(Items.name_tag, 0, 1, 1, 10), new WeightedRandomChestContent(Items.golden_horse_armor, 0, 1, 1, 2), new WeightedRandomChestContent(Items.iron_horse_armor, 0, 1, 1, 5), new WeightedRandomChestContent(Items.diamond_horse_armor, 0, 1, 1, 1)});
    ...
    {
        return GreaterDungeonHooks.getRandomDungeonMob(p_76543_1_);
    }
