...
public class ModelMechaWither
  extends ModelBase
{
  private ModelRenderer[] spine;
  private ModelRenderer[] heads;
  
  public ModelMechaWither(float p_i46302_1_)
  {
    ...
    this.heads = new ModelRenderer[6];
    ...
    this.heads[3] = new ModelRenderer(this, 0, 8);
    this.heads[3].addBox(-4.0F, -6.0F, 1.5F, 2, 2, 2, p_i46302_1_);
    this.heads[4] = new ModelRenderer(this, 0, 0);
    this.heads[4].addBox(-1.5F, -6.0F, 0F, 3, 6, 0, p_i46302_1_);
    this.heads[4].setRotationPoint(-2.5F, -6F, 2.5F);
    this.heads[5] = new ModelRenderer(this, 0, 0);
    this.heads[5].addBox(-1.5F, -6.0F, 0F, 3, 6, 0, p_i46302_1_);
    this.heads[5].setRotationPoint(-2.5F, -6F, 2.5F);
    this.heads[3].addChild(this.heads[4]);
    this.heads[3].addChild(this.heads[5]);
  }
  ...
  public void render(Entity p_78088_1_, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float p_78088_7_)
  {
    ...
    this.heads[0].render(p_78088_7_);
    this.heads[1].render(p_78088_7_);
    this.heads[2].render(p_78088_7_);
    this.heads[3].render(p_78088_7_);
    
    this.spine[0].render(p_78088_7_);
    this.spine[1].render(p_78088_7_);
    this.spine[2].render(p_78088_7_);
  }
  ...
  public void setRotationAngles(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity p_78087_7_)
  {
    ...
    this.heads[4].rotateAngleY = 0F + (p_78087_3_ * 0.25F);
    this.heads[5].rotateAngleY = 1.4F + (p_78087_3_ * 0.25F);
  }
  
  public void setLivingAnimations(EntityLivingBase p_78086_1_, float p_78086_2_, float p_78086_3_, float p_78086_4_)
  {
	  EntityMechaWither entitywither = (EntityMechaWither)p_78086_1_;
    for (int i = 1; i < 3; i++)
    {
