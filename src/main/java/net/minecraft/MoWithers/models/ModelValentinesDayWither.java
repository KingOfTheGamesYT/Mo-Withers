...
public class ModelValentinesDayWither
  extends ModelBase
{
  private ModelRenderer[] spine;
  private ModelRenderer[] heads;
  
  public ModelValentinesDayWither(float p_i46302_1_)
  {
  ...
  {
    EntityValentinesDayWither entitywither = (EntityValentinesDayWither)p_78086_1_;
    for (int i = 1; i < 3; i++)
    {
