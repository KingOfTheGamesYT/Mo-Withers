...
public class ModelFiveHeadedWither
  extends ModelBase
{
  private ModelRenderer[] spine;
  private ModelRenderer[] heads;
  
  public ModelFiveHeadedWither(float p_i46302_1_)
  {
    ...
    this.spine[0].addBox(-10.0F, -5.0F, -0.5F, 20, 3, 3, p_i46302_1_);
    this.spine[0].setTextureOffset(12, 22).addBox(-2.0F, -2.0F, -0.5F, 3, 6, 3, p_i46302_1_);
    this.spine[0].setTextureOffset(24, 22).addBox(-6.0F, 0.0F, 0.0F, 11, 2, 2, p_i46302_1_);
    ...
    this.spine[2] = new ModelRenderer(this, 0, 22);
    this.spine[2].addBox(0.0F, 0.0F, 0.0F, 3, 10, 3, p_i46302_1_);
    this.heads = new ModelRenderer[5];
    this.heads[0] = new ModelRenderer(this, 0, 0);
    this.heads[0].addBox(-4.0F, -4.0F, -4.0F, 8, 8, 8, p_i46302_1_);
    this.heads[0].rotationPointY = -9.0F;
    this.heads[1] = new ModelRenderer(this, 32, 0);
    this.heads[1].addBox(-3.0F, -3.0F, -3.0F, 6, 6, 6, p_i46302_1_);
    this.heads[1].rotationPointX = -10.0F;
    this.heads[1].rotationPointY = 5.0F;
    this.heads[2] = new ModelRenderer(this, 32, 0);
    this.heads[2].addBox(-3.0F, -3.0F, -3.0F, 6, 6, 6, p_i46302_1_);
    this.heads[2].rotationPointX = 10.0F;
    this.heads[2].rotationPointY = 5.0F;
    this.heads[3] = new ModelRenderer(this, 32, 0);
    this.heads[3].addBox(-3.0F, -3.0F, -3.0F, 6, 6, 6, p_i46302_1_);
    this.heads[3].rotationPointX = -10.0F;
    this.heads[3].rotationPointY = -6.0F;
    this.heads[4] = new ModelRenderer(this, 32, 0);
    this.heads[4].addBox(-3.0F, -3.0F, -3.0F, 6, 6, 6, p_i46302_1_);
    this.heads[4].rotationPointX = 10.0F;
    this.heads[4].rotationPointY = -6.0F;
  }
  ...
  {
    EntityDementedWither entitywither = (EntityDementedWither)p_78086_1_;
    for (int i = 1; i < 5; i++)
    {
