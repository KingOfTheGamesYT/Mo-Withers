...
public class ModelBedrockWither
  extends ModelBase
{
  private ModelRenderer[] spine;
  private ModelRenderer[] heads;
  
  public ModelBedrockWither(float p_i46302_1_)
  {
  ...
  public void setRotationAngles(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity p_78087_7_)
  {
    ...
    this.spine[1].rotateAngleX = ((0.25F + 0.05F * f6) * 3.1415927F);
    ...
    this.spine[2].rotateAngleX = ((0.6F + 0.1F * f6) * 3.1415927F);
  ...
  {
	  EntityBedrockWither entitywither = (EntityBedrockWither)p_78086_1_;
    for (int i = 1; i < 3; i++)
    {
