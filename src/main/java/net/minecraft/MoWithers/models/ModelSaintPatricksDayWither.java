...
public class ModelSaintPatricksDayWither
  extends ModelBase
{
  ...
  public ModelSaintPatricksDayWither(float p_i46302_1_)
  {
  ...
  {
    EntitySaintPatricksDayWither entitywither = (EntitySaintPatricksDayWither)p_78086_1_;
    
    this.heads[1].rotateAngleY = ((entitywither.func_82207_a(1) - p_78086_1_.renderYawOffset) / 57.295776F);
    this.heads[1].rotateAngleX = (entitywither.func_82210_r(1) / 57.295776F);
    this.heads[2].rotateAngleY = ((entitywither.func_82207_a(2) - p_78086_1_.renderYawOffset) / 57.295776F);
    this.heads[2].rotateAngleX = (entitywither.func_82210_r(2) / 57.295776F);
  }
}
