...
public class ModelGlassWither
  extends ModelBase
{
  private ModelRenderer[] spine;
  private ModelRenderer[] heads;
  
  public ModelGlassWither(float p_i46302_1_)
  {
  ...
  {
    float f6 = MathHelper.cos(p_78087_3_ * 0.3F);
    this.spine[1].rotateAngleX = (p_78087_5_ / 57.295776F) + ((0.065F + 0.05F * f6) * 3.1415927F);
    ...
    this.spine[2].rotateAngleX = (p_78087_5_ / 57.295776F) + ((0.265F + 0.1F * (MathHelper.cos(p_78087_3_ * 0.3F - 1F))) * 3.1415927F);
  ...
  {
	  EntityGlassWither entitywither = (EntityGlassWither)p_78086_1_;
    for (int i = 1; i < 3; i++)
    {
