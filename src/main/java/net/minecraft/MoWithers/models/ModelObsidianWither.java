...
public class ModelObsidianWither
  extends ModelBase
{
  private ModelRenderer[] spine;
  private ModelRenderer[] heads;
  
  public ModelObsidianWither(float p_i46302_1_)
  {
  ...
  {
    float f6 = MathHelper.cos(p_78087_3_ * 0.075F);
  ...
  {
	  EntityObsidianWither entitywither = (EntityObsidianWither)p_78086_1_;
    for (int i = 1; i < 3; i++)
    {
