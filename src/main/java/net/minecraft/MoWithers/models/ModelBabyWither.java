  ...
  extends ModelBase
{
  ...
  public ModelBabyWither(float p_i46302_1_)
  {
    ...
    this.heads[1].rotationPointX = -6.0F;
    ...
    this.heads[2].rotationPointX = 6.0F;
  ...
  public void render(Entity p_78088_1_, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float p_78088_7_)
  {
    ...
    GlStateManager.translate(0.0F, 18.0F * p_78088_7_, 0.0F);
    ...
    GlStateManager.translate(0.0F, 4.0F * p_78088_7_, 0.0F);
  ...
  {
    EntityBabyWither entitywither = (EntityBabyWither)p_78086_1_;
    for (int i = 1; i < 3; i++)
    {
