...
import net.minecraft.MoWithers.render.RenderSandWither;
...
public class LayerSandWitherAura
  implements LayerRenderer
{
  private static final ResourceLocation field_177217_a = new ResourceLocation("textures/blocks/sand.png");
  private final RenderSandWither field_177215_b;
  private final ModelSandWither field_177216_c = new ModelSandWither(0.5F);
  
  public LayerSandWitherAura(RenderSandWither p_i46105_1_)
  {
    this.field_177215_b = p_i46105_1_;
  }
  
  public void func_177214_a(EntitySandWither p_177214_1_, float p_177214_2_, float p_177214_3_, float p_177214_4_, float p_177214_5_, float p_177214_6_, float p_177214_7_, float p_177214_8_)
  {
  ...
  {
    func_177214_a((EntitySandWither)p_177141_1_, p_177141_2_, p_177141_3_, p_177141_4_, p_177141_5_, p_177141_6_, p_177141_7_, p_177141_8_);
  }
}
