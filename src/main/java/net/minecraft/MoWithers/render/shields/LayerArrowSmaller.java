  ...
  implements LayerRenderer
{
  ...
  public void doRenderLayer(EntityLivingBase p_177141_1_, float p_177141_2_, float p_177141_3_, float p_177141_4_, float p_177141_5_, float p_177141_6_, float p_177141_7_, float p_177141_8_)
  {
    ...
    if (i > 0)
    {
      ...
      Random random = new Random(p_177141_1_.getEntityId());
      ...
      for (int j = 0; j < i; j++)
      {
        ...
        entityarrow.prevRotationYaw = (entityarrow.rotationYaw = (float)(Math.atan2(f7, f9) * 180.0D / 3.141592653589793D));
        entityarrow.prevRotationPitch = (entityarrow.rotationPitch = (float)(Math.atan2(f8, f13) * 180.0D / 3.141592653589793D));
        double d0 = 0.0D;
        double d1 = 0.0D;
        double d2 = 0.0D;
