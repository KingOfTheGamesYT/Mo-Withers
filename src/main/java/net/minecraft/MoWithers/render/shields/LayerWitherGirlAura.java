...
public class LayerWitherGirlAura
  implements LayerRenderer
{
  ...
  private final ModelWitherGirl field_177216_c = new ModelWitherGirl(0.5F);
  
  public LayerWitherGirlAura(RenderWitherGirl renderWitherGirl)
  {
