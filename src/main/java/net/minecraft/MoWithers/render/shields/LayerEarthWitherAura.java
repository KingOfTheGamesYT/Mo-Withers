...
import net.minecraft.MoWithers.render.RenderEarthWither;
...
public class LayerEarthWitherAura
  implements LayerRenderer
{
  private static final ResourceLocation field_177217_a = new ResourceLocation("textures/blocks/dirt.png");
  private final RenderEarthWither field_177215_b;
  private final ModelEarthWither field_177216_c = new ModelEarthWither(0.5F);
  
  public LayerEarthWitherAura(RenderEarthWither p_i46105_1_)
  {
    this.field_177215_b = p_i46105_1_;
  }
  
  public void func_177214_a(EntityEarthWither p_177214_1_, float p_177214_2_, float p_177214_3_, float p_177214_4_, float p_177214_5_, float p_177214_6_, float p_177214_7_, float p_177214_8_)
  {
  ...
  {
    func_177214_a((EntityEarthWither)p_177141_1_, p_177141_2_, p_177141_3_, p_177141_4_, p_177141_5_, p_177141_6_, p_177141_7_, p_177141_8_);
  }
}
