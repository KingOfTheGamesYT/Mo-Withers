...
public class LayerCreeperWitherAura
  implements LayerRenderer
{
  ...
  private final ModelCreeperWither field_177216_c = new ModelCreeperWither(0.5F);
  
  public LayerCreeperWitherAura(RenderCreeperWither p_i46105_1_)
  {
