...
public class RenderWitherDragonProjectile extends Render
{
    private float scale;

    public RenderWitherDragonProjectile(RenderManager p_i46176_1_, float p_i46176_2_)
    {
        super(p_i46176_1_);
     ...
     */
    public void doRender(EntityWitherDragonProjectile entity, double x, double y, double z, float p_76986_8_, float partialTicks)
    {
        ...
        TextureAtlasSprite textureatlassprite = Minecraft.getMinecraft().getRenderItem().getItemModelMesher().getParticleIcon(MoWitherItems.enderCharge);
    ...
    protected ResourceLocation func_180556_a(EntityWitherDragonProjectile p_180556_1_)
    {
    ...
    {
        return this.func_180556_a((EntityWitherDragonProjectile)entity);
    }
    ...
    {
        this.doRender((EntityWitherDragonProjectile)entity, x, y, z, p_76986_8_, partialTicks);
    }
}