...
public class EntityAIPinkWitherGirlFollowPlayer extends EntityAIBase
{
    private EntityWitherGirlPink thePet;
    ...
    public EntityAIPinkWitherGirlFollowPlayer(EntityWitherGirlPink p_i1625_1_, double p_i1625_2_, float p_i1625_4_, float p_i1625_5_)
    {
    ...
    {
        return !this.petPathfinder.noPath() && this.thePet.getDistanceSqToEntity(this.theOwner) > (double)(this.maxDist * this.maxDist) && this.thePet.timeSinceDoingIt < 4000;
    }
