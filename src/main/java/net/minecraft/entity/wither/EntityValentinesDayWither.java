...
public class EntityValentinesDayWither
  extends EntityMob
  implements IBossDisplayData, IRangedAttackMob
{
  ...
  public EntityValentinesDayWither(World worldIn)
  {
    super(worldIn);
  ...
  public void onLivingUpdate()
  {
    ...
    for (int j = 0; j < 3; j++)
    {
      ...
      this.worldObj.spawnParticle(EnumParticleTypes.HEART, d10 + this.rand.nextGaussian() * 0.25D, d2 + this.rand.nextGaussian() * 0.25D, d4 + this.rand.nextGaussian() * 0.25D, 0.0D, 0.0D, 0.0D, new int[0]);
  ...
  private void launchWitherSkullToCoords(int p_82209_1_, double p_82209_2_, double p_82209_4_, double p_82209_6_, boolean p_82209_8_)
  {
    ...
    EntityLoveSkull entitywitherskull = new EntityLoveSkull(this.worldObj, this, d6, d7, d8);
    if (p_82209_8_) {
  ...
  public boolean attackEntityFrom(DamageSource source, float amount)
  {
    ...
    if ((source != DamageSource.fall) && (source != DamageSource.anvil) && (source != DamageSource.fallingBlock) && (source != DamageSource.drown) && (source != DamageSource.inWall) && (!(source.getEntity() instanceof EntityValentinesDayWither)))
    {
