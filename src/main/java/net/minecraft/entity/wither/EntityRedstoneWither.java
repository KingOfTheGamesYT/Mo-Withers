...
public class EntityRedstoneWither
  extends EntityMob
  implements IRangedAttackMob
{
  ...
  public EntityRedstoneWither(World worldIn)
  {
    super(worldIn);
  ...
  public void onLivingUpdate()
  {
        ...
        for (int i2 = -8; i2 <= 8; i2++) {
          for (int j = -8; j <= 8; j++)
          {
            ...
            if (block instanceof BlockRedstoneWire) {
            	this.worldObj.setBlockState(new BlockPos(j2, k, l), block.getStateFromMeta(15), 2);
            }
          }
        }
      }
    ...
    for (int j = 0; j < 3; j++)
    {
      ...
      if ((flag) && (this.worldObj.rand.nextInt(4) == 0)) {
        this.worldObj.spawnParticle(EnumParticleTypes.BLOCK_CRACK, d10 + this.rand.nextGaussian() * 0.30000001192092896D, d2 + this.rand.nextGaussian() * 0.30000001192092896D, d4 + this.rand.nextGaussian() * 0.30000001192092896D, 0.699999988079071D, 0.699999988079071D, 0.5D, new int[] {152});
      }
    }
    if (getInvulTime() > 0) {
      for (int j = 0; j < 15; j++) {
        this.worldObj.spawnParticle(EnumParticleTypes.REDSTONE, this.posX + this.rand.nextGaussian() * 1.0D, this.posY + this.rand.nextFloat() * 3.3F, this.posZ + this.rand.nextGaussian() * 0.6D, 0.0D, 0.0D, 0.0D, new int[] {42});
      }
    }
  }
  ...
  {
    return (block != Blocks.redstone_wire) && (block != Blocks.redstone_torch) && (block != Blocks.redstone_lamp) && (block != Blocks.lit_redstone_lamp) && (block != Blocks.unlit_redstone_torch) && (block != Blocks.lit_redstone_ore) && (block != Blocks.powered_repeater) && (block != Blocks.powered_comparator) && (block != Blocks.unpowered_repeater) && (block != Blocks.unpowered_comparator) && (block != Blocks.redstone_ore) && (block != Blocks.redstone_block) && (block != Blocks.barrier) && (block != Blocks.bedrock) && (block != Blocks.end_portal) && (block != Blocks.end_portal_frame) && (block != Blocks.command_block);
  }
  ...
  private void launchWitherSkullToCoords(int p_82209_1_, double p_82209_2_, double p_82209_4_, double p_82209_6_, boolean p_82209_8_)
  {
    ...
    entitywitherskull.setSkullType(5);
  ...
  public boolean attackEntityFrom(DamageSource source, float amount)
  {
    ...
    if ((source != DamageSource.fall) && (source != DamageSource.anvil) && (source != DamageSource.fallingBlock) && (source != DamageSource.drown) && (source != DamageSource.inWall) && (!(source.getEntity() instanceof EntityRedstoneWither)))
    {
