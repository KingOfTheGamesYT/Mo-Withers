  ...
  implements IRangedAttackMob
{
  ...
  public EntityFireWither(World worldIn)
  {
    super(worldIn);
  ...
  public void onLivingUpdate()
  {
    ...
    if ((!this.worldObj.isRemote) && (getWatchedTargetId(0) > 0))
    {
      ...
      if (entity != null)
      {
        if ((this.posY < entity.posY) || ((!isArmored()) && (!canConjoin()) && (this.posY < entity.posY + 8.0D)))
        {
  ...
  protected void updateAITasks()
  {
    ...
    {
      super.updateAITasks();
      if (this.worldObj.getWorldType() != WorldType.FLAT && (isWet()) || (this.worldObj.getBiomeGenForCoords(new BlockPos(MathHelper.floor_double(this.posX), 0, MathHelper.floor_double(this.posZ))) == BiomeGenBase.sky && this.isNotProtected()) || (this.worldObj.getBiomeGenForCoords(new BlockPos(this.posX, this.posY, this.posZ)).getFloatTemperature(new BlockPos(this.posX, this.posY, this.posZ)) < 0.1F) && this.isNotProtected()) {
      ...
      {
        heal(1.0F);
        if ((this.worldObj.getBiomeGenForCoords(new BlockPos(this.posX, this.posY, this.posZ)) == BiomeGenBase.forest) || (this.worldObj.getBiomeGenForCoords(new BlockPos(this.posX, this.posY, this.posZ)) == BiomeGenBase.birchForest) || (this.worldObj.getBiomeGenForCoords(new BlockPos(this.posX, this.posY, this.posZ)) == BiomeGenBase.forestHills) || (this.worldObj.getBiomeGenForCoords(new BlockPos(this.posX, this.posY, this.posZ)) == BiomeGenBase.roofedForest) || (this.worldObj.getBiomeGenForCoords(new BlockPos(this.posX, this.posY, this.posZ)) == BiomeGenBase.taiga) || (this.worldObj.getBiomeGenForCoords(new BlockPos(this.posX, this.posY, this.posZ)) == BiomeGenBase.taigaHills) || (this.worldObj.getBiomeGenForCoords(new BlockPos(this.posX, this.posY, this.posZ)) == BiomeGenBase.jungle) || (this.worldObj.getBiomeGenForCoords(new BlockPos(this.posX, this.posY, this.posZ)) == BiomeGenBase.jungleHills) || (this.worldObj.getBiomeGenForCoords(new BlockPos(this.posX, this.posY, this.posZ)) == BiomeGenBase.jungleEdge) || (this.worldObj.getBiomeGenForCoords(new BlockPos(this.posX, this.posY, this.posZ)) == BiomeGenBase.plains))
        {
          float f = 10.0F;
          float f1 = 1.0F;
          double d0 = MathHelper.getRandomDoubleInRange(this.rand, this.posX - f, this.posX + f);
  ...
  {
	  return !this.isInLava() && this.worldObj.getBlockState(getPosition()).getBlock() != Blocks.fire;
  }
  ...
  private void launchWitherSkullToCoords(int p_82209_1_, double p_82209_2_, double p_82209_4_, double p_82209_6_, boolean p_82209_8_)
  {
    ...
    EntityFireSkull entitywitherskull = new EntityFireSkull(this.worldObj, this, d6, d7, d8);
    if (p_82209_8_) {
  ...
  public boolean attackEntityFrom(DamageSource source, float amount)
  {
    ...
    if ((source != DamageSource.lava) && (source != DamageSource.inFire) && (source != DamageSource.onFire) && (!(source.getEntity() instanceof EntityFireWither)))
    {
  ...
  protected void dropFewItems(boolean p_70628_1_, int p_70628_2_)
  {
    ...
    if (!this.worldObj.isRemote)
    {
        ...
        while (iterator.hasNext())
        {
            ...
            entityplayer.triggerAchievement(MoWithersAchievments.achievementKillFireWither);
        }
    }
  }
