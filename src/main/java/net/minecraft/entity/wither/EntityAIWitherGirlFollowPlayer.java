...
{
    private EntityWitherGirl thePet;
    ...
    public EntityAIWitherGirlFollowPlayer(EntityWitherGirl p_i1625_1_, double p_i1625_2_, float p_i1625_4_, float p_i1625_5_)
    {
    ...
    {
        return !this.petPathfinder.noPath() && this.thePet.getDistanceSqToEntity(this.theOwner) > (double)(this.maxDist * this.maxDist) && !this.thePet.isChild() && this.thePet.timeSinceDoingIt < 4000;
    }
