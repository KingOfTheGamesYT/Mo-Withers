...
public class EntityAINearestWitherAttackTarget extends EntityAITarget
{
    ...
    protected final EntityAINearestWitherAttackTarget.Sorter theNearestAttackableTargetSorter;
    /**
    ...
    public EntityAINearestWitherAttackTarget(EntityCreature p_i45878_1_, Class p_i45878_2_, boolean p_i45878_3_)
    {
        this(p_i45878_1_, p_i45878_2_, p_i45878_3_, false);
    }

    public EntityAINearestWitherAttackTarget(EntityCreature p_i45879_1_, Class p_i45879_2_, boolean p_i45879_3_, boolean p_i45879_4_)
    {
        this(p_i45879_1_, p_i45879_2_, 10, p_i45879_3_, p_i45879_4_, (Predicate)null);
    }

    public EntityAINearestWitherAttackTarget(EntityCreature p_i45880_1_, Class p_i45880_2_, int p_i45880_3_, boolean p_i45880_4_, boolean p_i45880_5_, final Predicate p_i45880_6_)
    {
        super(p_i45880_1_, p_i45880_4_, p_i45880_5_);
        this.targetClass = p_i45880_2_;
        this.targetChance = p_i45880_3_;
        this.theNearestAttackableTargetSorter = new EntityAINearestWitherAttackTarget.Sorter(p_i45880_1_);
        this.setMutexBits(1);
        this.targetEntitySelector = new Predicate()
        {
            public boolean func_179878_a(EntityLivingBase p_179878_1_)
            {
                ...
                else
                {
                    ...
                    {
                        double d0 = EntityAINearestWitherAttackTarget.this.getTargetDistance();
                        ...
                        if ((double)p_179878_1_.getDistanceToEntity(EntityAINearestWitherAttackTarget.this.taskOwner) > d0)
                        {
                            return false;
                        }
                    }

                    return EntityAINearestWitherAttackTarget.this.isSuitableTarget(p_179878_1_, false);
                }
            }
