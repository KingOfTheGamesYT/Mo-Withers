  ...
  extends EntityFireball
{
  ...
  public EntityAirSkull(World worldIn, EntityLivingBase p_i1794_2_, double p_i1794_3_, double p_i1794_5_, double p_i1794_7_)
  {
  ...
  public EntityAirSkull(World worldIn, double p_i1795_2_, double p_i1795_4_, double p_i1795_6_, double p_i1795_8_, double p_i1795_10_, double p_i1795_12_)
  {
      ...
      if (movingObject.entityHit != null)
      {
        if (this.shootingEntity != null)
        {
          if (movingObject.entityHit.attackEntityFrom(DamageSource.setExplosionSource(null), 10.0F))
          {
            ...
            movingObject.entityHit.attackEntityFrom(DamageSource.inWall, 20.0F);
